        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center mb-6">
                    ...
                    />
                    <span class="text-xl font-bold">Vres Mastora</span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Καταχωρήστε Υπηρεσίες</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Αξιολογήσεις</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Εγγυήσεις Ποιότητας</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors duration-200 text-sm">Τιμές</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="text-gray-400 text-sm mb-4 md:mb-0">
                    © {{ date('Y') }} Vres Mastora. Με επιφύλαξη παντός δικαιώματος.
                </div>

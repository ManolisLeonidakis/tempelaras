...
@section('title', $user->name . ' - ' . ($user->idikotita ?? 'Επαγγελματίας') . ' | Fixado')
                ...
                <div class="flex-1 text-center lg:text-left">
                    ...
                    @if($user->city)
                        <div class="flex items-center justify-center lg:justify-start text-blue-100 mb-6">
                            ...
                            <span class="text-lg">
                                {{ isset($user->user_address['street']) ? $user->user_address['street'] . ', ' : '' }}
                                {{ $user->city ?? '' }}
                                {{ isset($user->user_address['postal_code']) ? ', ' . $user->user_address['postal_code'] : '' }}
                            </span>
                        </div>
                    @endif

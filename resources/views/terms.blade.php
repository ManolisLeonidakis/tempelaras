            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                <div class="p-8 md:p-12 space-y-10 leading-relaxed text-gray-700">
                    <div>
                        ...
                        <p class="mt-2">Με την πρόσβαση ή/και χρήση της πλατφόρμας Tempelaras, αποδέχεστε πλήρως τους παρόντες όρους χρήσης. Αν δεν συμφωνείτε, παρακαλούμε μην χρησιμοποιείτε την υπηρεσία.</p>
                    </div>
